...
def completionQuery(desc):
	openai.api_key = "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"
	
	#pull templateCoverLetterHere
	#cap completion to 10tokens
	prompt="Write a three paragraph cover letter for the position of software developer to " + desc + " as a soon to be graduate in major of computer science at Columbia University."
...
#urlScrape(url)
#descScrape_test() #current scrapes company name
integrated_test()
